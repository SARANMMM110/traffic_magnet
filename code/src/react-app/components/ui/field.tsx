...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-[[data-state=checked]]:bg-primary/5 has-[[data-state=checked]]:border-primary/50 gap-2 group-data-[disabled=true]/field:opacity-50 has-[[data-slot=field]]:rounded-xl has-[[data-slot=field]]:border [&_[data-slot=field]]:p-4 group/field-label peer/field-label flex w-fit leading-snug",
